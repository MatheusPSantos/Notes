...
public class AutenticacaoController {
    ...
    public ResponseEntity efeturarLogin(@RequestBody @Valid DadosAutenticacao dados) {
        var passwordEncoder = new SecurityConfigurations().passwordEncoder();
        var senhaCodificada = passwordEncoder.encode(dados.senha());
        var authenticationToken = new UsernamePasswordAuthenticationToken(dados.login(), senhaCodificada);
